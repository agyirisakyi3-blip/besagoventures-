          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex gap-3">
              {[
                ...
                >
                  <svg className="w-4 h-4" viewBox="0 0 24 24" fill={social.label === "WhatsApp" || social.label === "GitHub" || social.label === "Venmo" ? "currentColor" : "none"} stroke={social.label === "WhatsApp" || social.label === "GitHub" || social.label === "Venmo" ? "none" : "currentColor"} strokeWidth={social.label === "WhatsApp" || social.label === "GitHub" || social.label === "Venmo" ? 0 : 2} strokeLinecap="round" strokeLinejoin="round">
                    <path d={social.path} />
                  </svg>
                </a>
              ))}
